...
<?php
	...
	{
		header("Location:../fb_files/fb_home/postpage.php?post=".$postid);
	}
...
<a href="#" class="logo"><img src="images/logo.jpg" alt="" style="height:100%;" /></a>
				...
				<!-- Links -->
					<section>
						...
						<ul class="links">
							<?php
								$que_following_before=mysql_query("select * from categories");
					...
					<footer>
						...
						-->
							<ul class="stats">
								...
								<li><a href="sub.php?s=<?php echo $post_sub; ?>" style="background-color:#<?php echo $color_design;?>; color:white;" target='_blank' rel='noopener noreferrer'><?php echo $post_sub;?></a></li>
							</ul>
						</footer>
...
-->
    ...
    <article class="wrapper">
		  ...
		  <div class="comment-form-wrapper" style="width:100%; ">
