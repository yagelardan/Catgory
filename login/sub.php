<?php
	...
	$result = mysql_query("SELECT * FROM categories WHERE cat_name='$subname' LIMIT 1");
	$row = mysql_fetch_assoc($result);
	$color_design=$row['cat_color'];
	/*
	if($subname=="tech")
	{
		$color_design="cddc39";
...
<head style="background-color:#fafafa;">
...
<body style="background-color:#fafafa; font-family: Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif;">
	...
	<div id="wrapper">
		...
		<!-- Header -->
			<header id="header" style="background-color:rgba(255, 255, 255, 0.7); overflow: hidden; color:#000; border-style: solid; border-bottom: solid #<?php echo $color_design;?>;">
...
<!--<button class="btn">Log-in & Sign-up</button>-->
			...
			<?php
							...
							if(isset($_GET["err"]))
							{
								...
								if($error_id_get==0)
								{
									$error_text_get="Please fill all fields";
								}
								if($error_id_get==1)
								{
									$error_text_get="Please fill all fields";
				...
				<div class="tabs-content">
					...
					<!--sign up-->
					 <form  method="post" onSubmit="return check();" name="Reg">
						...
						<input type="text" name="email" class="sign-up-input" maxlength="30" placeholder="Username" >
						<!--<input type="text" name="remail" class="sign-up-input" placeholder="Re-enter mail">-->
						<input type="password" class="sign-up-input" name="Password" maxlength="25" placeholder="Password" >
					...
					<div id="login-tab-content"  class="active">
						...
						<form  method="post">
							...
							<input type="submit" value="Log in" name="Login" class="sign-up-button" id="" style="width:100%;">
						 </form><!--.login-form-->
			...
			<script src="popupjs/index.js"></script>
				...
				function country_change() {
					...
					window.location = "http://catgory.com/login/Home.php?cntry="+x;
				}
				</script>
