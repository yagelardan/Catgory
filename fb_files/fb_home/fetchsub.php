...
/* working
                            ...
                            WHERE sub_id='$sub_name' AND (user_post.country_id='$user_country' OR user_post.country_id='$user_second_country') AND ((UNIX_TIMESTAMP()-user_post.post_unix_time)>100 OR (user_post.user_id='$userid'))
...
/* working - random
							...
							FROM user_post LEFT JOIN user_likes 
							ON user_post.post_id = user_likes.post_id
                            WHERE sub_id='$sub_name' AND (user_post.country_id='$user_country' OR user_post.country_id='$user_second_country')
							GROUP BY user_post.post_id
					...
					-->
						...
						-->
							<ul class="stats">
								...
								<!--<li><a href="postpage.php?post=<?php echo $postid;?>" target='_blank' class="icon fa-heart"><?php echo $count_like;?></a></li>-->
								...
								<li><a href="postpage.php?post=<?php echo $postid;?>" style="font-weight: bold; border:0px;" target='_blank' rel='noopener noreferrer'>Read more</a></li>
							</ul>
						</footer>
					</article>
									<?php
