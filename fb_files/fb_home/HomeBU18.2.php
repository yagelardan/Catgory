...
<div style=" background:#F2F2F2; position:absolute; left:21%; top:26.5%; height:6.5%; width:41.4%; z-index:-1;"> </div>
	...
	<form method="post" name="posting_txt" onSubmit="return blank_post_check();" id="post_txt">
			...
			<div style="position:absolute; left:21.3%; top:11.5%;">
				<textarea style="height:100; width:550;" name="post_txt" maxlength="511" placeholder="Share your thoughts"></textarea>
...
<?php
	...
	if($len>0 && $len<=730)
	{
		$line1=substr($post_data[2],0,730);
	...
	<tr>
		...
		<figure style="background-color: #<?php echo substr(md5(rand()), 0, 6);?>;" class="snip1237">
		<a href="postpage.php?post=<?php echo $postid;?>">
		  <div class="image">
		  	<?php 
			...
			{
			?>
				<img src="../../fb_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Post/<?php echo $post_img; ?>"  onerror="this.src=''">
			<?php
				}
				else
				{
			...
			<div class="date"><span class="day"><?php echo date_format($date, 'd');?></span><span class="month"><?php echo substr(date_format($date, 'F'),0,3);?></span></div>
		  </div>
		  </a>
		  <figcaption>
			<h3 style="    font-size: 150%;"><?php echo $line1; ?></h3>
			<a href="postpage.php?post=<?php echo $postid;?>" class="read-more"> 
			Likes(<?php echo $count_like;?>) &nbsp;&nbsp;&nbsp;&nbsp; Comments(<?php echo $count_comment;?>)
			</a>
...
?>
	<tr>
		...
		<td width="4%" bgcolor="#EDEFF4" style="padding-left:12;" rowspan="2"> 
			<!--<img src="../../fb_users/<?php echo $user_gender1; ?>/<?php echo $user_Email1; ?>/Profile/<?php echo $user_pic1; ?>" height="40" width="47">-->    
		</td>
