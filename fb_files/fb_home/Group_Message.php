...
<body>
    ...
    <div style=" background:#FFF; position:absolute; left:25%; top:11.5%; height:21%; width:41.4%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);"> </div>
    <div style=" background:#F2F2F2; position:absolute; left:25%; top:27%; height:8%; width:41.4%; z-index:-1;"> </div>
    
    <form method="post" name="chat_form" onSubmit="return blank_chat_check()">
	
	<div style="position:absolute; left:25.3%; top:12.5%;">
    ...
    <div style="position:absolute; left:59%; top:29.6%;"> <input type="submit" value="Send" name="Message_send" id="chat_button" onClick="time_get()"> </div>
    </form>
...
?>
	...
	<tr>
    	<td style="padding-left:25;" rowspan="2"> <img src="../../fb_users/<?php echo $user_gender; ?>/<?php echo $user_email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55" onerror="this.src=''">  </td>
