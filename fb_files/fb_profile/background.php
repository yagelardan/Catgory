 ...
 <header>
  ...
  <nav role="navigation">
    ...
    <ul>
      ...
      <li class="active">
        <a href="../fb_home/Home.php" class="active"><span class="iconicstroke-home"></span> Home</a>
      </li>
      <li>
        <a href="../fb_home/Group_Message.php"><span class="iconicstroke-at"></span> Chat</a>
      </li>
      <li>
        <a href="#"><span class="iconicstroke-hash"></span> Discover</a>
      </li>
      <li>
        <a href="../fb_profile/Profile.php"><span class="iconicstroke-user"></span> Me</a>
      </li>
    ...
    <ul class="utilities">
      <li>
        <form name="fb_search" action="Search_Display_submit.php" method="get" onSubmit="return bcheck()">
			<!--<input class="search-input" type="text" id="search-query" placeholder="Search" name="q" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-haspopup="true" aria-controls="typeahead-dropdown-14" dir="ltr" style="direction: ltr; text-align: left;">-->
      ...
      <li><a href="#"><span class="iconicstroke-mail"></span></a></li>
      <li><a href="../fb_home/Settings.php" ><span class="iconicstroke-cog"></span></a></li>
	  <li><a href="../fb_logout/logout.php"><span class="iconicstroke-key-stroke"></span></a></li>
      <li></li>
    </ul>
...
<?php 
	...
	$count_bg=$count_bg+1;
?>
<div style="position:absolute; left:15.11%; top:6%;"> <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Cover/<?php echo $cover_img; ?>" height="279" width="943" onerror="this.src=''" onMouseOver="dis_cover_pic_edit();" onMouseOut="out_cover_pic_edit();" onClick="open_cover_photo()"> </div>
...
<div style="position:absolute; left:75%; top:30%; z-index:1; display:none;" id="edit_cover_button" > <input type="button" onMouseOver="dis_cover_pic_edit();" value="Change Cover" onerror="this.src=''" onMouseOut="out_cover_pic_edit();" onClick="Change_cover_pic()"> </div>
